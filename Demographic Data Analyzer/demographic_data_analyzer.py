...
def calculate_demographic_data(print_data=True):
    ...
    num_min_workers = df[ df['hours-per-week']== min_work_hours][df[ df['hours-per-week']== min_work_hours]['salary']=='>50K'].shape[0]
    ...
    highest_earning_country_percentage = float(df[df['salary']=='>50K']['native-country'].value_counts().loc[highest_earning_country]/ df.shape[0]*100)
